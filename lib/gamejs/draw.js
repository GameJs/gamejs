 ...
 */
exports.quadratic_curve = function(surface, color, startPos, endPos, controlPos, width) {
 ...
 */
exports.bezier_curve = function(surface, color, startPos, endPos, ct1Pos, ct2Pos, width) {
   if (!startPos || !(startPos instanceof Array)) {

...
(function() {
  ...
  */
  ...
  exports.init = function() {
    var canvas, lastPos, onBeforeUnload, onKeyDown, onKeyUp, onMouseDown, onMouseMove, onMouseScroll, onMouseUp;
    lastPos = [];
    ...
    */
    ...
    onKeyDown = function(ev) {
      ...
      if ((!ev.ctrlKey && !ev.metaKey && ((key >= exports.K_LEFT && key <= exports.K_DOWN) || (key >= exports.K_0 && key <= exports.K_z) || (key >= exports.K_KP1 && key <= exports.K_KP9) || key === exports.K_SPACE || key === exports.K_TAB || key === exports.K_ENTER)) || key === exports.K_ALT || key === exports.K_BACKSPACE) {
    ...
    */
    ...
    return canvas.addEventListener('beforeunload', onBeforeUnload, false);
  };

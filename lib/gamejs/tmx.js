 ...
 *
 * This module can load all ".tmx" files, no matter if they are
 * CSV or XML or even additionally base64 encoded (can be configured in Tiled).
 *
...
var loadLayers = function(mapNode) {
   ...
   var getGids = function(layerNode) {
      ...
      if (encoding === 'base64') {
         if (compression === 'gzip') {
            throw new Error('gzip compression unsupported');
         }

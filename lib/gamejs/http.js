...
(function() {
  var ajax, ajaxBaseHref, get, post, stringify;
  ...
  */
  ...
  ajax = exports.ajax = function(method, url, data, type) {
    var response;
    data = data || null;
  ...
  */
  ...
  post = exports.post = function(url, data, type) {
    return ajax('POST', url, data, type);
  };

  stringify = function(response) {
    /* eval is evil
    */
    return eval('(' + response.responseText + ')');
  };

  ajaxBaseHref = function() {
  ...
  */
  ...
  exports.save = function(url, data, type) {
    return stringify(post(ajaxBaseHref() + url, {
      payload: data
    }, type));
  };

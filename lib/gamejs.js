...
(function() {
  var DEBUG_LEVELS, RESOURCES, Rect, Surface, debugLevel, gamejs, log, matrix, normalizeRectArguments, objects, preload, resourceBaseHref,
    __slice = [].slice;
  ...
  */
  ...
  log = exports.log = function() {
    ...
    */
    ...
    if (window.console !== void 0 && console.log.apply) {
  ...
  */
  ...
  normalizeRectArguments = function() {
    var args, height, left, top, width;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    left = 0;
    top = 0;
    width = 0;
  ...
  */
  ...
  Surface = exports.Surface = function() {
  ...
  */
  ...
  Surface.prototype._smooth = function() {
    ...
    return this.context.mozImageSmoothingEnabled = true;
  };

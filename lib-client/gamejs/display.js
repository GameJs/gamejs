...
exports.init = function() {
   ...
   if (getCanvas() === null) {
      var jsGameCanvas = document.createElement("canvas");
...
exports._getCanvasOffset = function() {
   // FIXME this only works for the most basic case in firefox
   return [getCanvas().offsetLeft, getCanvas().offsetTop - document.body.scrollTop];
};
